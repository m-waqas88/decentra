      ...
      }
      {
        !walletStatus && (
          <div className="flex justify-center mt-20">
            <div className="flex flex-col w-1/2 color-white">
              <p className="p-6 text-justify"><span><b>Decentra</b></span> is a digital and decentralized social community that is built for a cause. Being a human, the best you can do for a human is to help human. Irrespective of religion, race, color, language, geographical locaiton, we believe in humanity.</p>
